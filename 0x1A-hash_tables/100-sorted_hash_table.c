...
/**
 * shash_table_create - To create a shash table with a given size
 *
...
/**
 * add_n_shash - To add a node at the beginning of a shash at a given index
 *
...
/**
 * add_i_shash - To add a node on the DLL of the shash table
 *
...
/**
 * shash_table_set - To add a hash (key, value) to a given shash table
 *
...
/**
 * shash_table_get - To retrieve a value associated with a key
 *
 * @ht: pointer to the shash table
 * @key: key of the shash
...
/**
 * shash_table_print - To print the keys and values of the shash table
 *
...
/**
 * shash_table_print_rev - To print the keys and values of the shash table
 * in reverse
 *
 * @ht: A pointer to the shash table
 * Return: no return
...
/**
 * shash_table_delete - To delete a shash table
 *
 * @ht: A pointer to the shash table
 * Return: no return
 */
